function bmiCalculation ()  {
    // variable
    let bmiMan = document.getElementById("bmiMan").checked;
    let bmiWoman = document.getElementById("bmiWoman").checked;
    ...
    if ((bmiMan == true || bmiWoman == true) && bmiAge != "" && bmiWeight != "" && bmiHeight != "") {
        // calculate BMI
